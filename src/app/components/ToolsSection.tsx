          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
            <div className="relative group/input">
              <input
                ...
                className="w-full sm:w-64 px-4 py-2.5 bg-background border border-border rounded-lg text-foreground dark:text-black dark:bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all placeholder:text-muted-foreground/60 dark:placeholder:text-gray-500"
            ...
            <select
              ...
              className="px-4 py-2.5 bg-background border border-border rounded-lg text-foreground dark:text-black dark:bg-white focus:outline-none focus:ring-2 focus:ring-primary transition-all cursor-pointer"
