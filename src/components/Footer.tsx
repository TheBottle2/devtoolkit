        ...
        <nav aria-label="Footer navigation">
          <ul className="flex items-center gap-6">
            ...
            <li>
              <Link
                href="#stack"
                className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors duration-200 py-2 px-1 rounded focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background"
              >
                Stack
              </Link>
            </li>
